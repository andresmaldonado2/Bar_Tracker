...
extern "C" jdoubleArray Java_com_example_main_1menu_helpers_PerformanceMetricHelper_performanceMetrics(JNIEnv *env, jobject obj, jdoubleArray posDataJArr, jint weight, jdouble intialVelocity, jboolean inKG);
